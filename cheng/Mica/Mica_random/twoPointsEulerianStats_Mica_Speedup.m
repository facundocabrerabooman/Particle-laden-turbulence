function [eulerStats pair]= twoPointsEulerianStats_Mica_Speedup(vtracks,dRminmax,Nbins,ifsubsmean,ifread,varargin)
...
disp('part begins ... ')
if ifsubsmean==1
    partname = '\EulerianPart_subsMean.mat';
elseif ifsubsmean==0
    partname = '\EulerianPart.mat';
end
if ifread == 1
    load([pwd partname]);
elseif ifread==0
    ...
    save([pwd partname],'part')
else
    error('Wrong Flag of Reading Files')
end
disp('part done !')

part=part(1:sparsifyratio:end);
...
eulerStats.Amoy=Amoy;
eulerStats.AmoyX=AmoyX;
eulerStats.AmoyY=AmoyY;
eulerStats.AmoyZ=AmoyZ;
...
disp('pair begins ... ')
if ifsubsmean==1
    pairname = '\EulerianPair_subsMean.mat';
elseif ifsubsmean==0
    pairname = '\EulerianPair.mat';
end
if ifread == 1
    load([pwd pairname]);
elseif ifread==0
