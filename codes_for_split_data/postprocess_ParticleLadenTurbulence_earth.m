...
save('output_post_processing_earth.mat','s','m','w','-append')
...
save([folderout filesep 'output_post_processing_earth.mat'],'Ine','Ine_acc','tracklong','-append')
...
save([folderout filesep 'output_post_processing_earth.mat'],'traj_dec','traj_ddt','traj_fullg','-append')
...
save('output_post_processing_earth.mat','pdfV','pdfA','-append')
...
save('output_post_processing_earth.mat','MSD','-append')
%%
figure;
...
save('output_post_processing_earth.mat','S2L','-append')
%%
